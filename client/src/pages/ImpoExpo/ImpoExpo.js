		...
		<>
			<Card
				...
				<Alert
					...
					showIcon
				/>
				<h3 className="input" style={{ fontSize: "24px" }}>
					Lecture-Data of your App
				</h3>
				...
				<Input
					className="input"
					size="large"
					placeholder="Paste Here LECTURE data of your friend"
					prefix={<UserOutlined />}
				...
				<Input
					className="input"
					size="large"
					placeholder="Paste Here LAB data of your friend"
					prefix={<UserOutlined />}
